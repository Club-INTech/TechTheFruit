...
int tableauO0[]={0,0,0,0};
int tableauO1[]={0,0,0,0};
int tableauO2[]={0,0,0,0};
 ...
 */
void mesureOptiques(int tableau[4]) {
  //prise des mesures
  tableau[0] = digitalRead(optPinAvG);
  tableau[1] = digitalRead(optPinAvD);
  tableau[2] = digitalRead(optPinArG);
  tableau[3] = digitalRead(optPinArD);
  //delai repos ;)
  delayMicroseconds(50);
}
