...
Manager::init()
{
	...
	assRotation.changeAcc(60);
	assRotation.changeVmax(30000);
	assRotation.changePWM(512);
	
	assTranslation.changeKp(40);
	assTranslation.changeAcc(40);
	assTranslation.changeVmax(12000);
	assTranslation.changePWM(300);
}
