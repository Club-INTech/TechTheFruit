...
class InterfaceAsservissement < SerieThread
        ...
        def callback retour
			...
			distance = (encodeurG - @encodeurPrecedentG + encodeurD - @encodeurPrecedentD) / @conversionTicksDistance
                        ...
                        # angleAvance = Vecteur.new(anciennePosition, @position).angle 
                        # if angleAvance > Math::PI/2 && angleAvance < Math::PI/2
                        #         @sens = 1
                        # else
                        #         @sens = 0
                        # end
